<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<?php echo base_url('/home/brick/' . $server_id); ?>"><?php echo $zfs[0]['server']; ?></a></li>
...
foreach($snapshots as $b):
$time = Time::parse($b['updated_at'], 'Europe/Brussels');
?>
    <tr>
        <td><?php echo $b['pool']; ?></td>
        <td><?php echo $b['brick']; ?></td>
        <td><?php echo $b['snapshot']; ?></td>
        <td><?php echo $time->humanize(); ?> (<?php echo $b['updated_at'] ?>)</td>
    <tr>
<?php endforeach; ?>
</table>
